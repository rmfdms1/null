const steps = [
  ...
  중국 최초의 달 탐사선인 <a href="jab10.html" target="_blank">살류트</a>, 미르창어 1호가 발사되어 달 궤도에 진입하였다.<br><br>
  이는 중국의 우주 개발 역사에서 중대한 전환점이 되었으며,<br>
  달 표면 탐사와 과학 연구의 기초 자료를 제공하였다.`,

  `2. 2013년 12월 2일: 창어 3호 착륙선 성공적 달 착륙<br><br>
  <a href="jab11.html" target="_blank">창어 3호</a> 착륙선이 성공적으로 달 표면 월령 3구역에 착륙하였다.<br><br>
  ...
  <a href="jab12.html" target="_blank">중계 위성</a>을 통한 통신 체계를 구축하여 탐사 임무를 완수하였다.<br><br>
