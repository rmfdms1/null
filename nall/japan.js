const steps = [
    ...
    일본 <a href="jab17.html" target="_blank">JAXA</a>의 전신인 NASDA가 다양한 우주 탐사 임무를 계획하기 시작했다.`,
  
    `2. 1998년: 하야부사(Hayabusa) 미션 시작 — 소행성 탐사를 통한 기술 축적<br><br>
    <a href="jab18.html" target="_blank">하야부사</a> 미션은 소행성 탐사와 샘플 수집에 집중하며, 원격 탐사 및 착륙 기술 개발에 큰 도움을 주었다.<br><br>
    ...
    <a href="jab19.html" target="_blank">가구야</a> 임무는 2013년 성공적으로 종료되었으며, 달에 대한 매우 정밀한 데이터를 과학계에 제공했다.<br><br>
    ...
    일본은 달 착륙을 목표로 하여 로봇 탐사선 발사와 <a href="jab20.html" target="_blank">달 기지</a> 건설 연구에 힘쓰고 있다.<br><br>
