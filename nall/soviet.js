const steps = [
    ...
    소련 우주비행사 유리 가가린이 보스토크 1호를 타고 지구 궤도를 돌며 인류 최초 유인 우주 비행에 성공하였다.<br><br>
    이는 소련의 우주 기술 우위를 세계에 보여주는 상징적인 사건이었다.`,
  
    `3. 1963년: 루나 프로그램 시작 — 무인 달 탐사 본격화<br><br>
    소련은 루나(Luna) 프로그램을 통해 무인 탐사선을 잇따라 발사하며 달 궤도 진입, 착륙, 샘플 회수 실험을 진행하였다.<br><br>
    ...
    소련은 유인 달 착륙 계획인 N1 로켓 개발에 실패하며 유인 달 탐사 계획을 중단하였다.<br><br>
    이는 미국 아폴로 계획에 대응하기 위한 시도였으나, 기술적 난관으로 인해 실행되지 못했다.`,
  
    `8. 1980년대 이후: 우주정거장과 다른 우주 프로그램에 집중<br><br>
    소련은 우주정거장 프로그램인 살류트, 미르에 집중하며 지구 저궤도 우주 개발에 힘썼다.<br><br>
